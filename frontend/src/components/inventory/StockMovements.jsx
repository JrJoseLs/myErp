...
import { ArrowUpCircle, ArrowDownCircle, RefreshCw, Plus } from 'lucide-react';
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <Select
        ...
        options={[
          ...
          { value: 'ajuste', label: 'Ajuste (Establecer Stock)' },
        ]}
        required
      />
        ...
        <div className="grid grid-cols-3 gap-4">
          <Select
            ...
            options={[
              ...
              ...products.map(p => ({ value: p.id, label: `${p.codigo} - ${p.nombre}` }))
            ]}
          />
