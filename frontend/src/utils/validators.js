...
/**
 * Utilidades de validación para el ERP/CRM
 */
...
export const validateNCF = (ncf, tipo = null) => {
  ...
  // ✅ Formato correcto: Letra + 2 dígitos + 8 dígitos = 11 caracteres
  // Ejemplo válido: B0100000001
  ...
  if (!match) {
    return {
      valid: false,
      message: 'Formato de NCF inválido. Debe ser: Letra + 2 dígitos + 8 dígitos (Ejemplo: B0100000001)',
    };
  }
  ...
  // Validar tipos válidos de NCF según DGII
  const tiposValidos = [
    'B01', // Crédito Fiscal
    'B02', // Consumo
    ...
    'B15', // Gubernamental
    'B16', // Exportaciones
    'E31', // Pagos al Exterior
    'E32', // Ingresos por Operaciones
    'E33', // Ingresos por Operaciones (No Residentes)
    'E34', // Ingresos por Arrendamiento
    'E41', // Compras
    'E43', // Gastos Menores
    'E44', // Régimen Especial de Tributación
    'E45', // Gastos por Combustible
    'E46', // Compras Crédito Fiscal
    'E47', // Compras con Derecho a Crédito Parcial
  ];

  if (!tiposValidos.includes(tipoCompleto)) {
    return {
      valid: false,
      message: `Tipo de NCF "${tipoCompleto}" no es válido según la DGII`,
      tipo: tipoCompleto,
    };
  }
