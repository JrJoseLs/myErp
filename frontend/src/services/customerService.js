...
    return data.id || data; 
  } catch (error) {
    console.error('Error al obtener el ID de Consumidor Final:', error);
    // Este error será capturado en POS.jsx para mostrar el mensaje de configuración.
    throw new Error('No se pudo obtener el ID del Consumidor Final. Verifique la configuración del servidor.');
  }
};